 ...
 * ES Module router for zero-cost, in-memory storage.
 * Mount: app.use('/api/attendance', memoryRoutes({ adminToken: process.env.ATTEND_ADMIN_TOKEN, persistFile: process.env.LOCAL_STATE_PATH }))
 */
